...
export const posts = {
	'design-to-code': {
		...
		description:
			'A practical guide to breaking down a design mockup into code-ready sections for developers.',
		status: 'published',
		...
		excerpt:
			'Learn how to break down a visual design mockup into manageable, code-ready sections and patterns.',
		featured: false,
	},
	'api-best-practices-beginner': {
		title: "API Best Practices: A Beginner's Guide to Building Better Web APIs",
		description:
			'Learn the best practices for building APIs, from clear naming conventions to security tips, in this beginner-friendly guide.',
		status: 'published',
	...
	'modern-js-patterns': {
		...
		description:
			'A practical guide to modern JavaScript patterns, including modules, async/await, composition, and more. Stay up to date with the latest best practices for writing clean, maintainable JS.',
		status: 'published',
		...
		excerpt:
			'Explore the latest JavaScript patterns and techniques for writing robust, modern web applications in 2025.',
		featured: false,
	},
	'docker-basics-guide-for-web-developers': {
		title: 'Docker for Web Developers: Simplifying Setup and Deployment',
		description:
			'A practical guide to using Docker, containers, and Docker Compose for modern web development and deployment.',
		status: 'published',
		...
		excerpt:
			'Learn how Docker, containers, and Docker Compose can simplify your web development workflow and deployment process.',
		featured: false,
	},
	'dns-web-browsing': {
	...
	'web-security-essentials': {
		...
		description:
			'Learn essential web security practices to protect your website from common threats. From SSL/TLS to security headers, we cover everything you need to know.',
		status: 'published',
		...
		excerpt:
			"Learn how to protect your website from common security threats with practical, actionable steps that don't require advanced technical knowledge.",
		featured: true,
	},
	'web-performance-optimization': {
		title: 'Speed Matters: A Practical Guide to Web Performance Optimization',
		description:
			"Learn practical strategies to optimize your website's performance, from caching to image optimization, with real-world examples and case studies.",
		status: 'published',
		...
		excerpt:
			'Discover how to make your website blazingly fast with practical optimization strategies, real-world case studies, and actionable tips you can implement today.',
		featured: false,
	},
	'git-basics': {
		title: 'Git Basics: Version Control Made Simple',
		description:
			'Learn the fundamentals of Git version control in plain English. Perfect for beginners who want to understand why version control matters and how to get started.',
		status: 'published',
...
export function setupRouterGuards(routerInstance) {
	routerInstance.beforeEach((to, from, next) => {
		...
		if (to.path === '/rss.xml' || to.path === '/tutorials.xml') {
