...
const frontmatter = {
	...
	description: 'Master working with colors and text styling in CSS',
	...
	<div class="content">
		<nav class="breadcrumb" aria-label="breadcrumbs">
			<ul>
				...
				<li class="is-active">
					<a href="#" aria-current="page">Colors & Typography</a>
				</li>
			</ul>
		</nav>
		...
		<header class="tutorial-header">
			...
			<h1 class="title is-1">
				<i class="fa-brands fa-css3 css-icon"></i>
				{{ frontmatter.title }}
			</h1>
		...
		<TutorialNavigation
			prev="css-basics-selectors"
			next="css-basics-box-model"
		/>
	</div>
</template>
