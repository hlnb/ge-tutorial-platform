	...
	<div class="box">
		...
		<div class="notification is-info is-light mt-4">
			<p>
				...
				text that contains links to other texts, creating a network of connected
				information. This was one of Tim Berners-Lee's core ideas when creating
				the World Wide Web.
			</p>
		</div>
	</div>
			...
			<div class="link-types">
				<div class="link-type">
					...
					<div class="box has-background-light">
						<CodeMirror v-model="internalLink" :height="80" :readonly="true" />
					</div>
					<p class="mt-2">
				...
				<div class="link-type mt-5">
					...
					<div class="box has-background-light">
						<CodeMirror v-model="externalLink" :height="100" :readonly="true" />
					</div>
					<p class="mt-2">
						Links to other websites. Best practice is to use target="_blank" and
						rel="external".
					</p>
				</div>
...
&lt;a href="contact.html"&gt;Here&lt;/a&gt;</code></pre>
			...
			<div class="notification is-info is-light mt-4">
				...
				<ul>
					<li>
						<strong>Be Descriptive:</strong> Link text should make sense out of
						context
					</li>
					<li>
						<strong>Avoid Generic Text:</strong> No "click here" or "read more"
					</li>
					<li>
						<strong>Indicate External Links:</strong> Let users know when links
						open in new tabs
					</li>
					<li>
					...
					<li>
						<strong>Consider Screen Readers:</strong> Use aria-label when needed
					</li>
				</ul>
			</div>
		...
		<div class="content">
			...
			<div class="notification is-info is-light mt-4">
				...
				<ul>
					...
					<li>Consider users with color blindness when choosing link colors</li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="box mt-6">
		...
		<div class="content">
			...
			<div class="notification is-warning is-light mt-4">
				...
				<ul>
					<li>
						<strong>Descriptive Link Text:</strong> Avoid "click here" or "read
						more"
					</li>
					<li>
						<strong>New Window Warning:</strong> Alert users when links open in
						new tabs
					</li>
					<li>
		...
		<div class="box mt-6">
			...
			<div class="content">
				...
				<div class="notification is-warning is-light mt-4">
					<p>
						<strong>Note:</strong> Navigation structures will be styled with CSS
						later. Focus on creating semantic, accessible HTML structure now.
					</p>
				</div>
			</div>
		</div>
