<template>
	...
	<div class="box is-info mb-6">
		...
		<p>If you've completed the Getting Started section, you'll already have:</p>
		<ul>
	...
	<p>
		...
		(European Organization for Nuclear Research). He needed a way for scientists
		to share documents and data across different computers and networks.
	</p>
	...
	<div class="timeline mb-6">
		...
		<div class="timeline-item">
			...
			<div class="timeline-content">
				...
				<p>
					HTML5 becomes the official standard, representing a complete overhaul
					of HTML
				</p>
			</div>
		</div>
	...
	<div class="box is-info mb-6">
		...
		<ul>
			...
			<li>
				...
				<strong>Mobile-first design</strong> - Better support for mobile devices
			...
			<li>
				...
				<strong>Semantic elements</strong> - New tags that give meaning to page
				structure
			</li>
			<li>
		...
		<p class="mt-4">
			...
			being just a markup language to becoming a platform for web applications.
		</p>
	</div>
	...
	<ol>
		<li>
			<i class="fas fa-arrow-right"></i> Your browser sends an HTTP request to a
			web server
		</li>
		<li>
		...
		<li>
			<i class="fas fa-desktop"></i> Your browser reads the HTML and renders it
		...
		<div class="columns mt-3">
			<div class="column is-6">
				<div class="notification is-primary is-light">
					...
					<ul>
						<li>
							<i class="fas fa-check"></i> Use the code editor right here in the
							tutorial
						</li>
	...
	<h2 class="title is-3"><i class="fas fa-laptop-code"></i> Try It Yourself</h2>
	...
	<div class="box">
		<h3 class="title is-4">
			<i class="fas fa-tasks"></i> Interactive Exercise: Create a Simple Profile
		</h3>
		...
		<details class="mt-4">
			...
			<div class="solution-container mt-4">
				<CodeMirror v-model="solutionExample" :height="150" :readonly="true" />
			</div>
		</details>
	</div>
	...
	<div class="box mt-6">
		<h2 class="title is-3">
			<i class="fas fa-project-diagram section-icon"></i> Your Learning Journey
		</h2>
		...
		<div class="notification is-info is-light mt-4">
			<p>
				...
				of this HTML series, you'll have two complete, well-structured websites
				ready for styling with CSS! The solid HTML foundation you build here
				will make adding beautiful designs and layouts much easier in the CSS
				tutorials.
			</p>
		</div>
	</div>
