<template>
  <div class="content">
    ...
    <h1 class="title is-1">
      <i class="fab fa-js"></i> Introduction to JavaScript
    </h1>
    ...
    <p>
      JavaScript is the programming language that makes websites interactive. It's like giving instructions to your website so it can respond to what users do.
    </p>
    ...
    <p>
      There are three ways to add JavaScript to your webpage. Think of these like different ways to attach an instruction manual to a product:
    </p>

    <div class="box">
      <h3 class="title is-4">1. Inline JavaScript</h3>
      <p>
        This is like writing instructions directly on a button. It's quick but gets messy for complex instructions.
      </p>
      ...
      <div class="mt-3">
        <button class="button" @click="showInlineAlert">Try it: Click me</button>
      </div>
    </div>
    ...
    <div class="box">
      ...
      <p>
        This is like including an instruction manual inside the product box. All the instructions are in one place within your HTML file.
      </p>
      <div class="codemirror-wrapper">
        <CodeMirror
    ...
    <div class="box">
      ...
      <p>
        This is like having a separate instruction manual that comes with the product. It keeps your HTML clean and your JavaScript organized in its own file.
      </p>
      <div class="codemirror-wrapper">
        <CodeMirror
      ...
      <p class="mt-3">
        And in a separate file named <code>script.js</code>:
      </p>
      <div class="codemirror-wrapper">
        <CodeMirror
    ...
    <div class="notification is-warning is-light">
      <p>
        ...
        <strong>Best Practice:</strong> External JavaScript is usually the best choice for real projects. It keeps your code organized and makes it easier to maintain.
      </p>
    </div>

    <h2 class="title is-2 mt-6">Using the Console</h2>
    <p>
      The browser console is like a backstage pass to your website. It lets you see what's happening behind the scenes and try out JavaScript code directly.
    </p>
    ...
    <div class="box">
      ...
      <ul>
        <li><strong>Windows/Linux:</strong> Press <kbd>F12</kbd> or <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>I</kbd></li>
        <li><strong>Mac:</strong> Press <kbd>Cmd</kbd> + <kbd>Option</kbd> + <kbd>I</kbd></li>
      </ul>
      ...
      <div class="mt-3">
        ...
        <div v-if="consoleOutput" class="console-output mt-3">
          <div v-for="(line, index) in consoleOutput" :key="index" class="console-line">
            ...
            <span v-else-if="line.type === 'output'" class="console-output-text">
              {{ line.text }}
            </span>
          </div>
        </div>
    ...
    <p>
      The DOM (Document Object Model) is like a family tree for your webpage. It represents every element on your page as objects that JavaScript can interact with.
    </p>
    <p>
      Think of it like this: The DOM is a map of your webpage that JavaScript can read and modify.
    </p>

    <div class="box">
      <h3 class="title is-4">1. Finding Elements</h3>
      <p>
        Before you can change something on your page, you need to find it first. This is like looking up someone's address before you can send them a letter.
      </p>
      <div class="codemirror-wrapper">
        <CodeMirror
          v-model="findElementExample"
          :options="{
            mode: 'javascript',
            theme: 'material',
            lineNumbers: true,
    ...
    <div class="box">
      ...
      <p>
        Once you've found an element, you can change what it says. This is like erasing a message on a whiteboard and writing a new one.
      </p>
      <div class="codemirror-wrapper">
        <CodeMirror
          v-model="changeContentExample"
          :options="{
            mode: 'javascript',
            theme: 'material',
            lineNumbers: true,
    ...
    <p>
      Conditions in JavaScript are like forks in a road - they let your code take different paths based on certain situations.
    </p>

    <div class="box">
      <h3 class="title is-4">Basic if/else Structure</h3>
      <p>
        Think of an if/else statement like a bouncer at a club:
      </p>
      <div class="codemirror-wrapper">
        <CodeMirror
          v-model="conditionExample"
          :options="{
            mode: 'javascript',
            theme: 'material',
            lineNumbers: true,
      ...
      <div class="mt-3">
        <div class="field has-addons">
          <div class="control">
            <input v-model="ageInput" class="input" type="number" placeholder="Enter your age">
          </div>
          <div class="control">
            <button class="button is-info" @click="checkAge">
              Check Age
            </button>
          </div>
        </div>
    ...
    <p>
      Let's try a basic counter. This is like a simple clicker game where you press a button and see a number go up.
    </p>
    ...
    <div class="box">
      ...
      <p>
        Let's create a button that toggles whether a menu item is available or sold out. This is like a light switch that you can flip back and forth.
      </p>
      <div class="columns">
        <div class="column">
          <h4 class="title is-5">HTML:</h4>
    ...
    <div class="notification is-danger is-light mt-6">
      ...
      <ul>
        <li>
          <strong>Forgetting to link the JavaScript file</strong> - Make sure your script tag has the correct path
        </li>
        <li>
          <strong>Missing semicolons</strong> - While JavaScript can sometimes work without them, it's good practice to end statements with semicolons
        </li>
        <li>
          <strong>Case sensitivity</strong> - JavaScript is case-sensitive, so <code>getElementById</code> is not the same as <code>getElementByID</code>
        </li>
        <li>
          <strong>Confusing = and ===</strong> - Single equals (=) assigns values, triple equals (===) compares values
        </li>
      </ul>
    </div>
    ...
    <div class="box">
      ...
      <ul>
        <li>
          <a href="https://console.learn.co" target="_blank">JavaScript Console Practice</a> - Try JavaScript in an online console
        </li>
        <li>
          <a href="https://javascript.info" target="_blank">JavaScript.info</a> - Comprehensive JavaScript guide
        </li>
        <li>
          <a href="https://www.codecademy.com/learn/introduction-to-javascript" target="_blank">Codecademy's JavaScript Course</a> - Interactive JavaScript lessons
        </li>
      </ul>
    </div>
    ...
    <div class="notification is-success is-light mt-6">
      <p>
        ...
        <strong>What's Next?</strong> In the next tutorial, we'll learn about variables and data types in JavaScript - the building blocks for storing and working with information.
      </p>
      <div class="mt-3">
        <router-link to="/tutorials/beginner/javascript-basics/variables-data-types" class="button is-success">
          Continue to Variables and Data Types <i class="fas fa-arrow-right ml-2"></i>
        </router-link>
      </div>
    </div>
...
// Code examples
const inlineJsExample = ref(`<button onclick="alert('Hello!')">Click me</button>`);
...
const runConsoleExample = () => {
  ...
  const lines = consoleExamples.value.split('\n').filter(line => 
  ...
  lines.forEach(line => {
    ...
    try {
      ...
      consoleOutput.value.push({ type: 'output', text: `Error: ${error.message}` });
    }
  });
};
...
const checkAge = () => {
  ...
  if (isNaN(age)) {
    ageResult.value = { message: 'Please enter a valid age', color: 'has-text-danger' };
  } else if (age >= 18) {
