	...
	<MainLayout>
		<div class="container">
			<section class="section">
				<div class="content">
					<h1 class="title">About GraphitEdge</h1>
					...
					<p class="is-size-5">
						...
						actually works, how to deploy a site, how to optimize for SEO, how
						to make designs functional in the real world?
					</p>
				...
				<div class="meet-helen mb-6">
					...
					<p class="is-size-5">
						...
						Over the years, I've worked as a developer, educator, and mentor,
						and I've seen countless beginners struggle—not because they can't
						code, but because they're missing the bigger picture of how web
						development really works.
					</p>

					<p class="feature-text">
						<i class="fas fa-lightbulb"></i> The problem? Most tutorials focus
						on syntax but leave out the crucial skills developers actually need.
					</p>

					<p class="is-size-5">
						I created GraphiteEdge to change that—to bridge the gap between
						code, design, and real-world web development using plain, visual,
				...
				<div class="mission-section has-background-light p-5 mb-6">
					...
					<ul class="checkmark-list">
						...
						<li>
							Self-taught developers fill in the missing knowledge that holds
							them back.
						</li>
						<li>
				...
				<div class="approach-section mb-6">
					...
					<p class="is-size-5">
						...
						That's why our tutorials are centered around "Rotto Rocks", a
						real-world project inspired by Rottnest Island's beauty and the
						Black Swan Bistro, a typical Western Australian restaurant.
					</p>
					...
					<p class="feature-text">
						...
						tutorials—GraphiteEdge gives you the missing pieces of web
						development in a structured, practical learning experience.
					</p>
				</div>
				...
				<div class="audience-section mb-6">
					...
					<ul class="checkmark-list">
						...
						<li>
							Anyone who wants to go beyond tutorials and actually understand
				...
				<div class="newsletter-section has-background-light p-5">
					...
					<p class="is-size-5">
						Want to be the first to know when new tutorials drop?
					</p>

					<p class="feature-text">
						<i class="fas fa-envelope"></i> Join the GraphiteEdge Insider
						Newsletter for:
					</p>
					...
					<p class="feature-text">
						<i class="fas fa-lightbulb"></i> Sign up today and start learning
						beyond just code!
					</p>
