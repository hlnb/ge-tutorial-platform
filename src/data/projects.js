...
const projectRecords = [
  {
    ...
    liveLinks: [
      {
        label: "View completed site",
        url: "/projects/black-swan-bistro/complete/index.html",
      },
      {
  ...
  },
  {
    ...
    description:
      "Rotto Rocks gives learners a realistic multi-page client project with a brief, wireframe choices, reference notes, and room to practise the full front-end workflow from structure through launch readiness.",
    type: "guided",
    difficulty: "medium",
    duration: "Capstone build",
    ...
    relatedTutorials: [
      ...
      "intermediate/responsive-refinement-for-reusable-components",
      "accessibility-essentials/accessibility-is-not-an-add-on",
      "accessibility-essentials/semantic-html-accessibility",
      "accessibility-essentials/images-alt-text-and-meaning",
      "accessibility-essentials/keyboard-navigation-and-focus-states",
      "accessibility-essentials/accessible-forms",
    ...
    sourceLinks: [
      {
        label: "Student project brief",
        url: "/projects/rotto-rocks/brief",
      },
      {
        label: "Download brief + wireframes PDF",
        url: "/projects/rotto-rocks/rotto-rocks-student-project-brief.pdf",
      },
      {
        label: "View wireframe options",
        url: "/projects/rotto-rocks/wireframes/index.html",
      },
      {
        label: "HTML project notes",
        url: "/projects/rotto-rocks/html-notes",
      },
      {
        label: "CSS project notes",
        url: "/projects/rotto-rocks/css-notes",
      },
    ],
    primaryPathway: "beginner",
    pathwayOrder: 2,
