...
const accessibilityEssentialsResources = [
  ...
  },
  {
    ...
    description:
      'A useful checklist for checking accessibility basics as you work.',
  },
  {
      ...
      resources: [
        {
          ...
          description:
            'How to set up a sensible file structure for your website.',
        },
        {
        ...
        },
        {
          ...
          description:
            'Quick visual reference for relative and absolute file paths.',
        },
      ],
    },
  },
    ...
    selectors: {
      practiceProjects: [
        ...
        },
        {
          ...
          description:
            'Use advanced selectors to create a responsive photo gallery',
    ...
    layout: {
      practiceProjects: [
        ...
        },
        {
          ...
          description:
            'Build a responsive photo gallery using CSS Grid and Flexbox',
          tags: ['CSS', 'Intermediate', 'Grid'],
          path: '/projects/photo-gallery-enhanced',
        },
      ],
      ...
      practiceProjects: [
        {
          title: 'Enhanced Todo List',
          description:
            'Add smooth animations and transitions to your todo list',
      ...
      resources: [
        {
          ...
          description:
            'A strong guide to what homepages should communicate and how people use them.',
        },
        {
          title: 'Atomic Design by Brad Frost',
          url: 'https://atomicdesign.bradfrost.com/chapter-2',
          description:
            'A useful introduction to thinking about interfaces as systems of smaller parts.',
        },
      ],
    },
    ...
    'why-your-css-isnt-working': {
      ...
      resources: [
        ...
        },
        {
          ...
          description:
            'Official guide to inspecting and editing CSS in Chrome DevTools.',
        },
      ],
    },
  },
      ...
      resources: [
        {
          ...
          description:
            'A layout-focused mental-model resource built around reusable composition patterns.',
        },
        {
          title: 'BEM — Block Element Modifier',
          url: 'https://getbem.com',
          description:
            'A clear naming approach for repeated layout and interface patterns.',
        },
      ],
    },
      ...
      resources: [
        {
          ...
          url: 'https://www.nngroup.com/articles/homepage-design-principles/',
          description:
            'Helpful for understanding homepage hierarchy, scanning, and user expectations.',
        },
        {
          title: 'Every Layout',
          url: 'https://every-layout.dev',
          description:
            'Useful for noticing reusable layout relationships beneath a visual mockup.',
        },
      ],
    },
      ...
      resources: [
        {
          ...
          url: 'https://every-layout.dev',
          description:
            'A strong reference for thinking about sections and composition as reusable patterns.',
        },
        {
          title: 'BEM — Block Element Modifier',
          url: 'https://getbem.com',
          description:
            'Useful when naming page regions and repeated blocks in a predictable way.',
        },
      ],
    },
      ...
      resources: [
        {
          ...
          url: 'https://developer.mozilla.org/en-US/docs/Learn/HTML/Introduction_to_HTML/Document_and_website_structure',
          description:
            'How to plan and structure a website with semantic HTML.',
        },
        {
          title: 'BEM — Block Element Modifier',
          url: 'https://getbem.com',
          description:
            'Useful for naming repeated CSS patterns clearly as your layout grows.',
        },
        {
          title: 'Every Layout',
          url: 'https://every-layout.dev',
          description:
            'A practical layout-thinking resource for reusable patterns like stacks, clusters, and grids.',
        },
      ],
    },
      ...
      resources: [
        {
          ...
          url: 'https://every-layout.dev',
          description:
            'Practical layout patterns that support reusable section rhythm and shared CSS decisions.',
        },
        {
          title: 'BEM — Block Element Modifier',
          url: 'https://getbem.com',
          description:
            'A helpful naming approach when shared section classes start turning into a system.',
        },
      ],
    },
      ...
      resources: [
        {
          ...
          description:
            'A visual guide for axis thinking, alignment, wrapping, and practical layout decisions.',
        },
        {
          title: 'Every Layout',
          url: 'https://every-layout.dev',
          description:
            'Useful for deciding when a row, cluster, or sidebar pattern is really a Flexbox problem.',
        },
      ],
    },
      ...
      resources: [
        {
          ...
          url: 'https://getbem.com',
          description:
            'A useful naming model for reusable interface blocks and their internal parts.',
        },
        {
          title: 'Every Layout',
          url: 'https://every-layout.dev',
          description:
            'Helpful for understanding reusable layout patterns as small composable building blocks.',
        },
      ],
    },
      ...
      resources: [
        {
          ...
          url: 'https://getbem.com',
          description:
            'A useful naming model for component shells and internal parts.',
        },
        {
          title: 'CSS-Tricks: A Complete Guide to Flexbox',
          url: 'https://css-tricks.com/snippets/css/a-guide-to-flexbox/',
          description:
            'Helpful when aligning navigation, footer links, and component interiors.',
        },
        {
          title: 'MDN: Document and website structure',
          url: 'https://developer.mozilla.org/en-US/docs/Learn/HTML/Introduction_to_HTML/Document_and_website_structure',
          description:
            'A useful refresher for keeping reusable HTML patterns semantic.',
        },
      ],
    },
      ...
      resources: [
        {
          ...
          description:
            'A practical visual reference for Grid properties, terminology, and layout examples.',
        },
        {
          title: 'CSS-Tricks: A Complete Guide to Flexbox',
          url: 'https://css-tricks.com/snippets/css/a-guide-to-flexbox/',
          description:
            'Useful for comparing Flexbox’s one-direction strengths with Grid’s two-dimensional layout model.',
        },
        {
          title: 'MDN: CSS Grid Layout',
          url: 'https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_grid_layout',
          description:
            'Reference and guides for using Grid when rows and columns matter together.',
        },
        {
          ...
          description:
            'A clear tutorial on grid containers, tracks, lines, cells, areas, gutters, and flexible tracks.',
        },
        {
          title: 'MDN: CSS Flexible Box Layout',
          url: 'https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_flexible_box_layout',
          description:
            'Canonical Flexbox reference for concepts, properties, and typical one-dimensional layout use cases.',
        },
        {
          title: 'Every Layout',
          url: 'https://every-layout.dev',
          description:
            'Helpful for connecting Grid decisions to repeated layout patterns instead of isolated syntax.',
        },
      ],
    },
      ...
      resources: [
        {
          ...
          url: 'https://developer.mozilla.org/en-US/docs/Learn/CSS/CSS_layout/Responsive_Design',
          description:
            'A solid refresher on media queries, flexible layouts, and responsive decisions.',
        },
        {
          title: 'MDN: Using Media Queries',
          url: 'https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_media_queries/Using_media_queries',
          description:
            'Reference for writing media queries when component behaviour needs to change.',
        },
        {
          title: 'MDN: CSS Values and Units',
          url: 'https://developer.mozilla.org/en-US/docs/Learn/CSS/Building_blocks/Values_and_units',
          description:
            'Useful background for relative units, viewport units, and flexible CSS values.',
        },
        {
          title: 'MDN: CSS Container Queries',
          url: 'https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_containment/Container_queries',
          description:
            'A later extension topic for components that need to respond to their own container size.',
        },
        {
          title: 'web.dev: Responsive design basics',
          url: 'https://web.dev/responsive-web-design-basics/',
          description:
            'Useful for reinforcing content-first breakpoint decisions and practical responsive patterns.',
        },
      ],
    },
      ...
      resources: [
        {
          ...
          url: 'https://developer.mozilla.org/en-US/docs/Learn/HTML/Introduction_to_HTML/Creating_hyperlinks',
          description:
            'A clear guide to links, URLs, and connecting pages together.',
        },
        {
          title: 'MDN: Dealing with files',
          url: 'https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/Dealing_with_files',
          description:
            'Useful for understanding folders, file names, and where assets should live.',
        },
        {
          title: 'MDN: Document and website structure',
          url: 'https://developer.mozilla.org/en-US/docs/Learn/HTML/Introduction_to_HTML/Document_and_website_structure',
          description:
            'Helpful background for planning page regions and shared site structure.',
        },
      ],
    },
    'black-swan-bistro-part-4': {
      ...
      resources: [
        ...
        },
        {
          ...
          url: 'https://developer.mozilla.org/en-US/docs/Learn/HTML/Introduction_to_HTML/Document_and_website_structure',
          description:
            'Helpful background for planning page regions and shared site structure across multiple pages.',
        },
        {
          title: 'web.dev: Learn HTML — Navigation',
          url: 'https://web.dev/learn/html/navigation',
          description:
            'Practical guidance on navigation patterns, breadcrumbs, and global vs local navigation.',
        },
      ],
    },
      ...
      resources: [
        {
          ...
          description:
            'Clear explanation of how selectors compete and why some rules win.',
        },
        {
          title: 'MDN: Inheritance',
          url: 'https://developer.mozilla.org/en-US/docs/Web/CSS/inheritance',
          description:
            'Helpful for understanding which properties inherit and why some styles flow through the document.',
        },
      ],
    },
      ...
      resources: [
        {
          ...
          description:
            'Reference for practical decorative and structural pseudo-element use cases.',
        },
        {
          title: 'MDN: Using CSS transitions',
          url: 'https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_transitions/Using_CSS_transitions',
          description:
            'A practical guide to restrained motion and transition choices.',
        },
      ],
    },
      ...
      resources: [
        {
          ...
          description:
            'A practical guide to reading browser errors and narrowing JavaScript problems step by step.',
        },
        {
          ...
          description:
            'Helpful background on using browser panels to inspect structure, styles, and page behaviour.',
        },
        {
          title: 'MDN: HTTP response status codes',
          url: 'https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Status',
          description:
            'Useful when the Network panel shows 404 or other loading failures.',
        },
      ],
    },
      ...
      resources: [
        {
          ...
          description:
            'Accessibility media query for users who prefer less motion.',
        },
        {
          title: 'web.dev: Prefers reduced motion',
          url: 'https://web.dev/articles/prefers-reduced-motion',
          description:
            'Practical advice on respecting the reduced motion preference in CSS and JavaScript.',
        },
      ],
    },
  },
      ...
      resources: [
        {
          ...
          description:
            'Practical guidance for making production pages faster and easier to use.',
        },
        {
          ...
          description:
            'A clear explanation of title, description, viewport, and other head metadata.',
        },
        {
          title: 'Chrome Lighthouse overview',
          url: 'https://developer.chrome.com/docs/lighthouse/overview',
          description:
            'Use Lighthouse as a final review tool after you understand what it is checking.',
        },
      ],
    },
      ...
      resources: [
        {
          ...
          description:
            'Audit your site for performance, accessibility, and SEO.',
        },
      ],
    },
  },
      ...
      practiceProjects: [
        {
          ...
          description:
            'Install Git, set your username/email, and configure your default editor.',
        ...
        },
        {
          ...
          description:
            'Run git --version and git config --list to verify your setup.',
    ...
    'on-page-seo': {
      ...
      resources: [
        ...
        },
        {
          ...
          description:
            'How AI features in Search relate to website owners and publishers.',
        },
        {
          title:
            'Google Search Central: Performing well in AI experiences on Search',
          url: 'https://developers.google.com/search/blog/2025/05/succeeding-in-ai-search',
          description:
            'Current Google guidance on succeeding in AI-shaped search experiences.',
        },
        {
          title: 'Google Search Central: Introduction to structured data',
          url: 'https://developers.google.com/search/docs/appearance/structured-data/intro-structured-data',
          description:
            'How structured data helps Google understand eligible page content.',
        },
      ],
    },
  },
...
export const tutorialEditorialContent = Object.fromEntries(
  Object.entries(legacyTutorialEditorialContent).map(
    ([section, sectionTutorials]) => [
      section,
      Object.fromEntries(
